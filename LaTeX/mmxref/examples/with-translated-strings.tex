...
\RenewDocumentCommand \mmxFormatBackRef { m m m }
  {
    \str_case:nnF {#1}
      {
        { part } { à~la~partie \nobreakspace #2~page \nobreakspace #3 }
        ...
        % Intentional: « sous-section » is too ugly here
        { subsection } { à~la~section \nobreakspace #2~page \nobreakspace #3 }
        % Ditto
        { subsubsection } { à~la~section \nobreakspace #2~page \nobreakspace
        #3 }
        { paragraph } { au~paragraphe \nobreakspace #2~page \nobreakspace #3 }
        % Ditto
        { subparagraph } { au~paragraphe \nobreakspace #2~
                           page \nobreakspace #3 }
      }
      {
        \msg_error:nnn { mmxref } { main/undefined-ref-format-for-counter } {#1}
